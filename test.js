const category = async () => {
  ...
  const showCard = (cardId, isSorting = false) => {
...
//  sorting data
  ...
  const sortBtn = () => {
    categoryCard();// Reload the cards without sorting first
    showCard('', true); // Sort the cards by views in descending order
  };
 
  
  // Initial loading of cards and categories
  categoryCard();
  category();
